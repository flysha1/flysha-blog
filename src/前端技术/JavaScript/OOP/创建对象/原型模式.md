...
```flow
p1=>operation: person1
op1=>operation: 实例中读取 name 属性
op2=>operation: 在实例中读取 name 属性成功

p1(right)->op1(right)->op2
```

```flow
p1=>operation: person2
op1=>operation: 实例中读取 name 属性
op2=>operation: 实例中无 name 属性
op3=>operation: 从原型链中读取 name 属性成功

p1(right)->op1(right)->op2(right)->op3
```
